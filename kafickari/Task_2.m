...
mat2rawMASK(movingMask,tempFile,'fixedM')
mat2rawMASK(fixwedMask,tempFile,'movingM')
...
CMD = ['elastix\elastix -f ' NewPath '\fixed.mhd -m ' NewPath...
    '\moving.mhd -out ' NewPath ' -p '  ParPath '\Parameters_Affine.txt -fMask ' NewPath '\fixedM.mhd -mMask ' NewPath '\moving.mhd']; %elastix
% 
